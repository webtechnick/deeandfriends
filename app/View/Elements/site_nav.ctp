      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-picture"></span> Photos', array('admin' => true, 'plugin' => null, 'controller' => 'uploads', 'action' => 'index'), array('escape' => false)); ?></li>
